...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let high_priority = NotifyOptions::new()
        .with_priority(2);  // Highest priority: 2
    ...
    let low_priority = NotifyOptions::new()
        .with_priority(-2);  // Lowest priority: -2
    ...
    let critical = NotifyOptions::new()
        .with_priority(2)
        .with_sticky(true);
